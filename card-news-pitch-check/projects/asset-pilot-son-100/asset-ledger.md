...
| 6 | Bridge | `assets/pitchcheck/dashboard.jpg` | direct-use | 팀 기록이 쌓이는 장면으로 전환한다. 앱 화면은 크게, 광고 문구는 최소화한다. |
| 7 | CTA | `assets/pitchcheck/dashboard.jpg` + `pitchcheck-wordmark-horizontal.png` | direct-use | 프로필 링크와 댓글 `[피치체크]` CTA. 실제 앱 화면과 실제 로고를 함께 사용한다. |
